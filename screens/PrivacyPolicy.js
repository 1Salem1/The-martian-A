...
const Policy = () => {
  ...
  <List.Section style={{color : 'blue'}}   titleStyle={{ color: '#000000', fontFamily: 'MuseoSans_700', fontSize: 18, fontWeight: '400', fontStyle: 'normal', textAlign: 'left', lineHeight: 36,}}>
      <List.Accordion   expanded={true}  theme={{ colors: { primary: '#e8500e' } }}  titleStyle={{fontSize:14}} style={{backgroundColor:'white' , height : 50}}
        title="Personal Data"
